...
import com.maquinaria.ecommerce.backend.domain.model.DataPayment;
import com.maquinaria.ecommerce.backend.domain.model.URLPaypalResponse;
import com.maquinaria.ecommerce.backend.infrastructure.service.PaypalService;
...
public class PaypalController {
    ...
    private final String SUCCESS_URL = "http://localhost:9092/api/v1/payments/success";
    private  final String CANCEL_URL = "http://localhost:9092/api/v1/payments/cancel";
