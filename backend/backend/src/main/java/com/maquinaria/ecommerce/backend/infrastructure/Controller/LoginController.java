...
import com.maquinaria.ecommerce.backend.infrastructure.dto.JWTClient;
import com.maquinaria.ecommerce.backend.infrastructure.dto.UserDTO;
import com.maquinaria.ecommerce.backend.infrastructure.jwt.JWTGenerator;
...
public class LoginController {
    ...
    public ResponseEntity<JWTClient> login(@RequestBody UserDTO userDTO){
        ...
        log.info("Rol de user: {}",SecurityContextHolder.getContext().getAuthentication().getAuthorities().stream().parallel().findFirst().get().toString());
